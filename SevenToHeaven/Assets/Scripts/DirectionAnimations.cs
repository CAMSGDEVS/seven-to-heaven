...
public class DirectionAnimations : MonoBehaviour
{
    ...
    private void AngledAnimation() {
        ...
        if (spriteIndex == 7) {
        ...
        } else if (spriteIndex == 6 && transitionFrames < 5) {
            if (AngleToIndex(previousAngle) < 6) {
            ...
            if (frameCycle == 0) {
                ...
                if (spriteIndex == 6) {
                    sevenSpriteR.sprite = sevenFlyingSprites[7];
                } else if (AngleToIndex(previousAngle) >= angle && spriteIndex < 6) {
                    sevenSpriteR.sprite = sevenFlyingSprites[spriteIndex + 1];
                } else if (AngleToIndex(previousAngle) < angle && spriteIndex > 0) {
                    sevenSpriteR.sprite = sevenFlyingSprites[spriteIndex - 1];
                } else {
                    sevenSpriteR.sprite = sevenFlyingSprites[spriteIndex];
                }
